...
class VentanaCurso(tk.Toplevel):
    def __init__(self, parent):
        ...
        entry_nombre_curso = tk.Entry(frame)
        self.entry_nombre_curso =entry_nombre_curso
        entry_nombre_curso.grid(row=0, column=1)
        
        # Horas
        label_horas = tk.Label(frame, text="Horas Totales Cursada:")
        label_horas.grid(row=1, column=0, sticky="w", pady=5)
        entry_horas_totales = tk.Entry(frame)
        self.entry_horas_totales = entry_horas_totales
        ...
        entry_horas_semanales = tk.Entry(frame)
        self.entry_horas_semanales = entry_horas_semanales
        ...
        self.entry_turnos = entry_turnos
        ...
        self.entry_profesor = entry_profesor
        ...
        btn_guardar = tk.Button(frame, text="Guardar", command= self.guardar_datos)
    ...
    def guardar_datos(self):
        ...
        horas_totales = self.entry_horas_totales.get()
        turnos = self.entry_turnos.get()
        horas_semanales = self.entry_horas_semanales.get()
        nombre_profesor = self.entry_profesor.get()
